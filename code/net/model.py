...
import torch
from thirdparty.deform_conv.modules import DeformConvPack
...
class conv_2(nn.Module):
    def __init__(self, in_channels, out_channels, k_size, stride, dilation, dropout=0.1):
        ...
        self.cn2 = nn.Sequential(nn.BatchNorm2d(in_channels),
                                 nn.Sigmoid(),
                                 DeformConvPack(in_channels, out_channels, kernel_size=k_size, stride=stride, padding=0, dilation=dilation),,
